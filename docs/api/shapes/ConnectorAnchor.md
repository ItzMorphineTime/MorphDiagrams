...
Diagram shape implementation for `ConnectorAnchor`.
...
* [shapes/ConnectorAnchor](#module_shapes/ConnectorAnchor)
    ...
    * _inner_
        * [~ConnectorAnchor](#module_shapes/ConnectorAnchor..ConnectorAnchor) ⇐ <code>BaseShape</code>
            * [new ConnectorAnchor()](#new_module_shapes/ConnectorAnchor..ConnectorAnchor_new)
...
**Kind**: inner class of [<code>shapes/ConnectorAnchor</code>](#module_shapes/ConnectorAnchor)  
